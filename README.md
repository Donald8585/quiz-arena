...
> Players join rooms, vote on a quiz topic, race through timed questions, and watch scores update live on a WebSocket-powered leaderboard — all running across two EC2 instances, eight Docker containers, and fully automated with Terraform.
...
**Two EC2 instances, eight containers:**
