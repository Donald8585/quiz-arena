...
resource "aws_security_group" "ec2_sg" {
  ...
  ingress { from_port = 80;   to_port = 80;   protocol = "tcp"; cidr_blocks = ["0.0.0.0/0"]; description = "Nginx" }
  ...
  ingress { from_port = 9090; to_port = 9090; protocol = "tcp"; cidr_blocks = [var.my_ip]; description = "Prometheus" }
